...
var file_proxy_freedom_config_proto_rawDesc = []byte{
	...
	0x10, 0x00, 0x12, 0x09, 0x0a, 0x05, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x10, 0x01, 0x42, 0x5f, 0x0a,
	...
	0x69, 0x2f, 0x78, 0x72, 0x61, 0x79, 0x2d, 0x63, 0x6f, 0x72, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x78,
...
func file_proxy_freedom_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proxy_freedom_config_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proxy_freedom_config_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Config); i {
			case 0:
				return &v.state
			case 1:
