# UPDATE
The project is now DEPRECATED, since the [xray project](https://github.com/imannamdari/xray-core) added support for ech. However, current project still pass ech traffic over ssh tunnel which does not implemented in [xray project](https://github.com/imannamdari/xray-core).

# XRAY with ECH support
This is an experimental project that adds ECH support to [xray project](https://github.com/imannamdari/xray-core).
